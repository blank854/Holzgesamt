        ...
        <Form onSubmit={handleCreateAdvert}>
          ...
          <Col md={12}>
            ...
            <div className='user p-4 rounded bg-light box-shadow'>
              ...
              >
                ...
                <Col sm={2}>
                  <div className='d-flex'>
                    ...
                    <DropdownButton
                      id='dropdown-price'
                      title={priceType ? priceType : setPriceType('Festpreis')}
                      variant='dark'
              ...
              <Form.Group as={Row} controlId='formFile' className='mb-3 d-flex'>
                <Col xs={12} md={2}>
                  ...
                  <Col sm={5}>
                    <div className='d-flex'>
                      <Form.Control
                        ...
                        maxLength='150px'
                      />
                      <Form.Label column sm={2} md={2} className='text-center'>
                        Meter
                      </Form.Label>
                      <Form.Control
                        type='circumference'
